...
// MC
const char* fileMC = "AnalysisResults.root";
const char* listMC = "protonTrkCutsMC"; // protons, aprotons
const char* listMmc = "DCAPtBinning";
...
void FitDCAxyProt(int bin = 9){
    ...
    TH3F* hMCprim_3d = (TH3F*)fileMC->Get(listMC)->FindObject(listMC)->FindObject(listMC)->FindObject(listMCprim)->Clone("hMCprim_3d");
    hMCprim_3d->Sumw2();

    TH3F* hMCsecM_3d = (TH3F*)fileMC->Get(listMC)->FindObject(listMC)->FindObject(listMC)->FindObject(listMCsecM)->Clone("hMCsecM_3d");
    hMCsecM_3d->Sumw2();

    TH3F* hMCsecW_3d = (TH3F*)fileMC->Get(listMC)->FindObject(listMC)->FindObject(listMC)->FindObject(listMCsecW)->Clone("hMCsecW_3d");
    hMCsecW_3d->Sumw2();
