...
MakeHighMultSpectrumD(){

  gStyle->SetLegendBorderSize(0);

TFile *file_p = new TFile("RawSpectrum_FitLoose_adeut.root");

TFile *file_high_p = new TFile("Raw_Spectra_Antideuteron.root");


TH1F *hRawSpec_p = (TH1F*) file_p->Get("hRawSpectrum")->Clone("hRawSpec_p");

TH1F *hRawSpec_high_p = (TH1F*) file_high_p->Get("hRawSpectrum Antideuteron")->Clone("hRawSpec_ap");
...
hRawSpectrum->Update();
legend->Draw();
hRawSpectrum->SaveAs("Normalization_ADeuterons.root");
